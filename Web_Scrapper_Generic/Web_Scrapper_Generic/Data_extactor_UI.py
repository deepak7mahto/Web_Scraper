...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 661, 51))
        ...
        self.select_csv_file_pushButton = QtGui.QPushButton(self.layoutWidget3)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(30, 480, 701, 71))
        self.groupBox_3.setObjectName(_fromUtf8("groupBox_3"))
        self.status_msgs_listWidget = QtGui.QListWidget(self.groupBox_3)
        self.status_msgs_listWidget.setGeometry(QtCore.QRect(10, 20, 681, 41))
