...
class Ui_mailing_dialog(object):
    def setupUi(self, mailing_dialog):
        ...
        self.send_mail_pushButton_emailtab.setCheckable(True)
        self.send_mail_pushButton_emailtab.setAutoExclusive(True)
        ...
        self.stop_mail_pushButton_emailtab.setCheckable(True)
        self.stop_mail_pushButton_emailtab.setAutoExclusive(True)
        ...
        self.reset_pushButton_emailtab.setCheckable(True)
        self.reset_pushButton_emailtab.setAutoExclusive(True)
        ...
        self.quit_pushButton.setCheckable(True)
        self.quit_pushButton.setAutoExclusive(True)
